        ...
        <div className="bg-white py-8 sm:py-12">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-center">Notre actualité</h2>
              <p className="mt-2 text-lg leading-8 text-gray-600 text-center">Découvrez l'actualité de votre musée virtuel, une actualité disponible pour tous et avec transparence.</p>
            </div>
            <div
                className="mx-auto mt-16 grid grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              <article className="flex flex-col items-start justify-between">
                ...
                <div className="max-w-xl">
                  <div className="mt-8 flex items-center gap-x-4 text-xs">
                    ...
                    <a className="relative cursor-none z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">Digital</a>
                  </div>
                  ...
                  <div className="relative mt-8 flex items-center gap-x-4">
                    ...
                    <div className="text-sm leading-6">
                      ...
                      <p className="text-gray-600">Journaliste</p>
                    </div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col items-start justify-between">
                ...
                <div className="max-w-xl">
                  ...
                  <div className="group relative">
                    ...
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">Le département des antiquités orientales du musée du Louvre accueille
              ...
              <article className="flex flex-col items-start justify-between">
                ...
                <div className="max-w-xl">
                  ...
                  <div className="group relative">
                    ...
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">La fille du peintre Philip Guston fait don de 220 œuvres
