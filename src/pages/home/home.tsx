        ...
        <>
            {isLoading ? (
                ...
                <>
                    ...
                    <OeuvreSection title="Ancient Near Eastern Art" datas={artworkAncientNearEasternArtDepartment}></OeuvreSection>
                    <OeuvreSection title="Arts of Africa, Oceania, and the Americas" datas={artsofAfricaOceaniaAmericasDepartment}></OeuvreSection>
